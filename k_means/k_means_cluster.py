...
max_stock = max(stock)
min_stock = min(stock)
print "Exercised stock options maximum: ", max_stock, "minimum: ", min_stock
print float(1000000-min_stock)/(max_stock-min_stock)
...
print "Salary maximum: ", max_salary, "minimum: ", min_salary
print float(200000-min_salary)/(max_salary-min_salary)